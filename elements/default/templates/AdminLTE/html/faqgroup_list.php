...
<div id="content">
    <div id="display_list">
      ...
      <div class="tab_separator">&nbsp;</div>
      <div class="tabs2" name='tt1' id='tt1' onmouseover="javascript:this.className='tabs1';" onmouseout="javascript:this.className='tabs2';" ><?php echo $BL->props->lang['+faqgroup']; ?></div>
      <div class="tab_separator">&nbsp;</div>
		          ...
		          <?php if (!count($faqgroups)) { ?>
    				<tr>
    					<td class="text_grey" colspan="3">
                        	<div align='center'>
                        	<?php echo $BL->props->lang['No_faqgroup']; ?>
                        	</div>
    					</td>
    				</tr>
		          <?php } else { ?>
					<td class='text_grey' width="1%"></td>
                      <td class='text_grey'>
					  <b><?php echo $BL->props->lang['+faqgroup']; ?></b></td>
                      <td class='text_grey' width='10%'></td>
                    </tr>		
					<?php foreach ($faqgroups as $key => $val) { ?>
                    <tr> 
					...
					<td class='text_grey' width="1%"></td>
                      <td class='text_grey'>
					  <?php echo $val['faqgroup_name']; ?></td>
                      <td class='text_grey' width='10%'><div align='right'>
                      <?php if($BL->getCmd("editfaqgroup")){ ?>
                      <a href='<?php echo $PHP_SELF; ?>?cmd=editfaqgroup&faqgroup_id=<?php echo $val['faqgroup_id']; ?>'><img src='elements/default/templates/alp_admin/images/edit_all.gif' alt='<?php echo $BL->props->lang['Edit']; ?>' border='0'></a>
                      &nbsp;
                      <?php } ?>                      
                      <?php if($BL->getCmd("delfaqgroup")){ ?>
                      <a href="javascript:if(confirm('<?php echo $BL->props->lang['Do_you_want_to_delete_this_faqgroup']; ?>'))document.location='<?php echo $PHP_SELF; ?>?cmd=delfaqgroup&faqgroup_id=<?php echo $val['faqgroup_id']; ?>'"><img src='elements/default/templates/alp_admin/images/delete.gif' alt='<?php echo $BL->props->lang['Delete']."?"; ?>' border='0'></a>
                      &nbsp;
                      <?php } ?>
                      </div></td>
                    </tr>

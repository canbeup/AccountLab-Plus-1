...
<div id="content">
    <div id="display_list">
      <div class="tabs" name='tt1' id='tt1' onmouseover="javascript:this.className='tabs1';" onmouseout="javascript:this.className='tabs';" ><a href="admin.php?cmd=addons" class="add_link"><?php echo $BL->props->lang['~addons']; ?></a></div>
				...
				<tr>
				    ...
				    <table width='100%' border='0' cellspacing='0' cellpadding='0'>
                      <tr> 
						...
						<div id="form1_field"> 
                            <input name='addon_name' type='text' class='search' id='addon_name' size='20' value='<?php if($cmd=="edit_addon")echo $addon['addon_name']; ?>' />
                          </div></td>
                      </tr>
                      <tr> 
                      ...
                      <tr> 
						...
						<div id="form1_field">
                            <input name='addon_setup' type='text' class='search' id='addon_setup' size='20' value='<?php if($cmd=="edit_addon")echo $addon['addon_setup']; ?>' />
                          </div></td>
                      </tr>
                      <tr> 
                        <td colspan='2' class='text_grey'>
                      ...
                      <tr> 
						...
						<div id="form1_field">
                            <input name='<?php echo $cv; ?>' type='text' class='search' size='20' value='<?php if($cmd=="edit_addon")echo $addon_cycles[$cv]; ?>' />
                          </div></td>
                      </tr>
                      <tr> 
                        <td colspan='2' class='text_grey'>
                      ...
                      <tr> 
						...
						<div id="form1_field">
                        	<?php if($cmd=="edit_addon"){ ?>
                            <input type='hidden' name='addon_id' value='<?php echo $addon['addon_id']; ?>' />
                            <?php } ?>
                            <input type='hidden' name='cmd' value='<?php echo $cmd; ?>' />
                            <input name='submit' type='submit' class='search1' value='<?php if($cmd=="edit_addon")echo $BL->props->lang['Update'];else echo $BL->props->lang['add']; ?>' />
                          </div></td>
                      </tr>
                    </table>
				  </form>

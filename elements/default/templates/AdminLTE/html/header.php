...
<html>
    <head>
        <meta charset="UTF-8">
        <title><?php echo $page_name; ?> | <?php echo $BL->props->lang['accountlabplus']; ?></title>
        ...
        <!-- Theme style -->
        <link href="elements/default/templates/AdminLTE/css/AdminLTE.css" rel="stylesheet" type="text/css" />
...
<?php include_once $BL->props->get_page("templates/AdminLTE/html/_javascripts.php"); ?>
    </head>
	...
	<?php include_once $BL->props->get_page("templates/alp_admin/html/alert.php"); ?>
        ...
        <header class="header">
            <a href="index.html" class="logo">
                ...
                <img src="elements/default/templates/AdminLTE/img/alp_logo_white.png">
            </a>
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header bg-light-blue">
                                    <img src="http://www.gravatar.com/avatar/<?php echo md5( strtolower( trim( $_SESSION['admin_email'] ) ) ); ?>" class="img-circle" alt="User Image" />
                                    <p>
			...
			<aside class="right-side">                
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <!-- <li class="active"><?php echo $page_parent; ?></li>-->

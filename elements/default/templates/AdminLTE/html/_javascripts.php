        ...
        if(cmd == 1)
        {
            if (http_request.readyState == 4) {
                if (http_request.status == 200) {
                    ...
                    if(status1=='online')
                        document.getElementById(img_id).innerHTML='<i class=\"ion ion-checkmark-round\" alt=\"---\" style=\"color:#27ae60\"></i>';
                    else
                        document.getElementById(img_id).innerHTML='<i class=\"ion ion-close-round\" alt=\"---\" style=\"color:#c0392b\"></i>';
                } else {
                    document.getElementById(img_id).innerHTML='<i class=\"ion ion-close-round\" alt=\"---\" style=\"color:#c0392b\"></i>';
                }
            }
